...
pokemon_list = [pikachu, bulbasour, charmender, squirtle, ratata, nidoking,
         jigglypuff, meowth, persion, abra, kadabra, Iyvasour]
...
def player1():
    ...
    random_dice_game["image"] = random_pokemon
    
    random_power_list = power_list[random_no]
    player1_score += random_power_list
...
def player2():
    ...
    random_dice_game["image"] = random_pokemon2
    
    random_power_list2 = power_list[random_no2]
    player2_score += random_power_list2
